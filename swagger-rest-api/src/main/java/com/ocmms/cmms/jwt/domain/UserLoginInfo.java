...
/**
 * Data Transfer Object used to bind, validate and process user data received as
 * request parameters during authentication and authorization process.
 * 
 * Also this DTO lets to fetch detached user data from the repository avoiding
 * issues with data lazy load.
 *
...
public class UserLoginInfo {
	...
	public UserLoginInfo(Long id, String username, String password, Calendar fromDate, Calendar thruDate,
			Boolean locked, Set<String> userLoginRoles) {
		this.id = id;

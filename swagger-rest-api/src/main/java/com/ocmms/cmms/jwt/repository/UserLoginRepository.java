...
public interface UserLoginRepository
		extends JpaRepository<UserLogin, Long>, PagingAndSortingRepository<UserLogin, Long> {
	 ...
	 * 
	 * @param username name of the user
	 * @return UserLogin entity or null if there's not exists any active UserLogin

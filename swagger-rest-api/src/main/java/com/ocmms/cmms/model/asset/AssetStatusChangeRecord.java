...
/**
 * = AssetStatusChangeRecord TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "ASSET_ASSETSTATUSCHANGERECORD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class AssetStatusChangeRecord implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "assetStatusChangeRecordGen", sequenceName = "SEQ_ASSET_ASSETSTATUSCHANGERECORD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "assetStatusChangeRecordGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "assetStatusChangeRecord")
	...
	public String toString() {
		return "AssetStatusChangeRecord {" + "id='" + id + '\'' + ", changeDate='" + changeDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(changeDate.getTime()) + '\'' + ", description='"

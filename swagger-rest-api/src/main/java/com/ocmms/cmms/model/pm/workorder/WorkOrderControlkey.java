...
/**
 * = WorkOrderControlkey TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_WORKORDER_CONTROLKEY")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class WorkOrderControlkey implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "controlkeyGen", sequenceName = "SEQ_PM_WORKORDER_CONTROLKEY_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "controlkeyGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "WorkOrderControlkey {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

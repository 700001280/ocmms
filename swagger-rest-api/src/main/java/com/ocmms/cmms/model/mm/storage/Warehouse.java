...
/**
 * = Warehouse TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_STORAGE_WAREHOUSE")
...
public class Warehouse implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "warehouseGen", sequenceName = "SEQ_MM_STORAGE_WAREHOUSE_ID")
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "warehouse")
	...
	public String toString() {
		//return organization.toString() +"-" + description;
		return description;
	 ...
	 */
	public void addToStorageLocations(Iterable<StorageLocation> storageLocationsToAdd) {
	 ...
	 */
	public void removeFromStorageLocations(Iterable<StorageLocation> storageLocationsToRemove) {

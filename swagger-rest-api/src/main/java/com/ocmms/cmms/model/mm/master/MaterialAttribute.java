...
/**
 * = MaterialAttribute TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_MASTER_MATERIALATTRIBUTE")
...
public class MaterialAttribute implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "materialAttributeGen", sequenceName = "SEQ_MM_MASTER_MATERIALATTRIBUTE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "materialAttributeGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "MaterialAttribute {" + "id='" + id + '\'' + ", attributeName='" + attributeName + '\''

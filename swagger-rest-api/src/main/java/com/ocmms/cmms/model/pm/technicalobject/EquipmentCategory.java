...
/**
 * = EquipmentCategory TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TECHNICALOBJECT_EQUIPMENTCATEGORY")
...
public class EquipmentCategory implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "equipmentCategoryGen", sequenceName = "SEQ_PM_TECHNICALOBJECT_EQUIPMENTCATEGORY_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipmentCategoryGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "equipmentCategory")
	...
	public String toString() {
		return "EquipmentCategory {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

...
/**
 * = ObjectType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_OBJECTTYPE")
...
public class ObjectType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "objectTypeGen", sequenceName = "SEQ_PM_CONFIGURATION_OBJECTTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "objectTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "objectType")
	...
	private Set<SubObjectType> subObjectTypes = new HashSet<SubObjectType>();
	...
	public String toString() {
		return "ObjectType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''
	 ...
	 */
	public void addToSubObjectTypes(Iterable<SubObjectType> subObjectTypesToAdd) {
	 ...
	 */
	public void removeFromSubObjectTypes(Iterable<SubObjectType> subObjectTypesToRemove) {

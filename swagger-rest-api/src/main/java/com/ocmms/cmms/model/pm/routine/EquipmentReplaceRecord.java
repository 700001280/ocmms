...
@Entity
@Table(name = "PM_ROUTINE_EQUIPMENTREPLACERECORD")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class EquipmentReplaceRecord implements Serializable {
	...
	public String toString() {
		return "EquipmentReplaceRecord {" + "id='" + id + '\'' + ", description='" + description + '\''

...
/**
 * = ReportTemplateDefinition TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "SYSTEM_REPORTTEMPLATEDEFINITION")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class ReportTemplateDefinition implements Serializable {
	...
	public String toString() {
		return "ReportTemplateDefinition {" + "id='" + id + '\'' + ", template='" + template + '\'' + ", className='"
				+ className + '\'' + ", description='" + description + '\'' + ", title='" + title + '\''
				+ ", systemDefault='" + systemDefault + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

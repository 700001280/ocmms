...
/**
 * = MaterialDiscipline TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_MASTER_MATERIALDISCIPLINE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class MaterialDiscipline implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "materialDisciplineGen", sequenceName = "SEQ_MM_MASTER_MATERIALDISCIPLINE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "materialDisciplineGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "MaterialDiscipline {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", discipline='"
				+ discipline + '\'' + ", version='" + version + '\'' + ", createdDate='" + createdDate == null
						? null

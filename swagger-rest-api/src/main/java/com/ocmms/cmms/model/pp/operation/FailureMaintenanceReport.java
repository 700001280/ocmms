...
/**
 * = FailureMaintenanceReport TODO Auto-generated class documentation
 *
 */
@Data
@EntityListeners(AuditingEntityListener.class)
@Entity
@Table(name = "PP_FAILUREMAINTENANCEREPORT")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class FailureMaintenanceReport extends NotificationHeader implements Serializable {	

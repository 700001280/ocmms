...
/**
 * = CriticalClassification TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "ESHEM_CRITICALCLASSIFICATION")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class CriticalClassification implements Serializable {
	...
	public String toString() {
		return "CriticalClassification {" + "id='" + id + '\'' + ", category='" + category + '\'' + ", description='"
				+ description + '\'' + ", subCategory='" + subCategory + '\'' + ", subDescription='" + subDescription
				+ '\'' + ", riskMatrix='" + riskMatrix + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

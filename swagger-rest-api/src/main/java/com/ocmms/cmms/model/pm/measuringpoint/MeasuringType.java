...
/**
 * = MeasuringType TODO Auto-generated class documentation
 *
 */
@Data
...
public class MeasuringType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "measuringTypeGen", sequenceName = "SEQ_PM_MEASURINGTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "measuringTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "MeasuringType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

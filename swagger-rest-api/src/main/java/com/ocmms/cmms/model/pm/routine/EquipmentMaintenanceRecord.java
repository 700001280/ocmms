...
@Entity
@Table(name = "PM_ROUTINE_EQUIPMENTMAINTENANCERECORD")
...
public class EquipmentMaintenanceRecord implements Serializable {
	...
	public String toString() {
		return "EquipmentMaintenanceRecord {" + "id='" + id + '\'' + ", maintStartDate='" + maintStartDate == null
				? null
				: java.text.DateFormat.getDateTimeInstance().format(maintStartDate.getTime()) + '\''
						+ ", maintEndDate='" + maintEndDate == null
								...
								: java.text.DateFormat.getDateTimeInstance().format(maintEndDate.getTime()) + '\''
										+ ", description='" + description + '\'' + ", downtime='" + downtime + '\''
										+ ", shutdown='" + shutdown + '\'' + ", interim='" + interim + '\''

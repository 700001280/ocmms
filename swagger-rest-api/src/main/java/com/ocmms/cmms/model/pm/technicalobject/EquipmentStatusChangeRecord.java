...
/**
 * = EquipmentStatusChangeRecord TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TECHNICALOBJECT_EQUIPMENTSTATUSCHANGERECORD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class EquipmentStatusChangeRecord implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "equipmentStatusChangeRecordGen", sequenceName = "SEQ_TECHNICALOBJECT_EQUIPMENTSTATUSCHANGERECORD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipmentStatusChangeRecordGen")
	@Column(name = "ID")
	private Long id;
	...
	@JoinColumn(name = "EQUIPMENTSTATUS")
	...
	public String toString() {
		return "EquipmentStatusChangeRecord {" + "id='" + id + '\'' + ", changeDate='" + changeDate == null ? null

...
/**
 * = WorkLogType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "ASSISTANCE_WORKLOGTYPE")
@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class WorkLogType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "workLogTypeGen", sequenceName = "SEQ_ASSISTANCE_WORKLOGTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "workLogTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "workLogType")
	...
	public String toString() {
		return "WorkLogType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''

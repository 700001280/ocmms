...
/**
 * = Vendor TODO Auto-generated class documentation
 *
 */
@Data
...
public class Vendor implements Serializable {
	...
	public String toString() {
		return "Vendor {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", companyName='" + companyName + '\''
				+ ", address='" + address + '\'' + ", postalCode='" + postalCode + '\'' + ", phone='" + phone + '\''
				+ ", fax='" + fax + '\'' + ", web='" + web + '\'' + ", mail='" + mail + '\'' + ", version='" + version
						...
						: java.text.DateFormat.getDateTimeInstance().format(createdDate.getTime()) + '\''
								+ ", createdBy='" + createdBy + '\'' + ", lastModifiedDate='" + lastModifiedDate == null
										...
										: java.text.DateFormat.getDateTimeInstance().format(lastModifiedDate.getTime())
												+ '\'' + ", lastModifiedBy='" + lastModifiedBy + '\'' + ", available='"
												+ available + '\'' + ", responsible='" + responsible + '\''

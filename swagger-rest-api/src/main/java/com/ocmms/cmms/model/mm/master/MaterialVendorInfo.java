...
/**
 * = MaterialVendorInfo TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_MASTER_MATERIALVENDORINFO")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class MaterialVendorInfo implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "materialVendorInfoGen", sequenceName = "SEQ_MM_MASTER_MATERIALVENDORINFO_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "materialVendorInfoGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 */
	@NotNull
	@Column(name = "VENDORINFOTYPE")
	private String vendorInfoType;
	...
	public String toString() {
		return "MaterialVendorInfo {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", code='" + code
				+ '\'' + ", vendorInfoType='" + vendorInfoType + '\'' + ", version='" + version + '\''

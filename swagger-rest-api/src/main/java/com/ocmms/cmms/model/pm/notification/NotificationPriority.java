...
/**
 * = NotificationPriority TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_PRIORITY")
...
public class NotificationPriority implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "notificationPriorityGen", sequenceName = "PM_NOTIFICATION_PRIORITY_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "notificationPriorityGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "priority")
	...
	public String toString() {
		return "NotificationPriority {" + "id='" + id + '\'' + ", priority='" + priority + '\'' + ", schedule='"
				+ schedule + '\'' + ", complete='" + complete + '\'' + ", notificationType='" + notificationType + '\''

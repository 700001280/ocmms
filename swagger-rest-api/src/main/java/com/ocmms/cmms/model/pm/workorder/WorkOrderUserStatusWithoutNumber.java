...
/**
 * = WorkOrderUserStatusWithoutNumber TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_WORKORDER_USERSTATUSWITHOUTNUMBER")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class WorkOrderUserStatusWithoutNumber implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "WorkOrderUserStatusWithoutNumberGen", sequenceName = "SEQ_PM_WORKORDER_USERSTATUSWITHOUTNUMBER_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "WorkOrderUserStatusWithoutNumberGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "WorkOrderUserStatusWithoutNumber {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='"

...
/**
 * = WorkOrderTimeSheet TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_WORKORDER_TIMESHEET")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class WorkOrderTimeSheet implements Serializable {
	...
	public String toString() {
		return "WorkOrderTimeSheet {" + "id='" + id + '\'' + ", workHours='" + workHours + '\'' + ", workDate='"
				+ workDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(workDate.getTime()) + '\''
								+ ", approveDate='" + approveDate == null
										? null
										: java.text.DateFormat.getDateTimeInstance().format(approveDate.getTime())

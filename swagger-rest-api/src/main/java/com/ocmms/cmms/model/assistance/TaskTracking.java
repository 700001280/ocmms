...
/**
 * = TaskTracking TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "ASSISTANCE_TASKTRACKING")
...
public class TaskTracking implements Serializable {
	...
	public String toString() {
		return "TaskTracking {" + "id='" + id + '\'' + ", submitDate='" + submitDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(submitDate.getTime()) + '\'' + ", description='"
						+ description + '\'' + ", targetDate='" + targetDate == null
								? null
								: java.text.DateFormat.getDateTimeInstance().format(targetDate.getTime()) + '\''
										+ ", assignDate='" + assignDate == null
												? null
												: java.text.DateFormat.getDateTimeInstance()
														.format(assignDate.getTime()) + '\'' + ", completeDate='"
														+ completeDate == null
																? null
																: java.text.DateFormat.getDateTimeInstance()
																		.format(completeDate.getTime()) + '\''
																		+ ", reference='" + reference + '\''
																		+ ", memo='" + memo + '\'' + ", version='"

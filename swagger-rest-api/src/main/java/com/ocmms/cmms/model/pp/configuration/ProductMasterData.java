...
/**
 * = ProductMasterData TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PP_CONFIGURATION_PRODUCTMASTERDATA")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class ProductMasterData implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "productMasterDataGen", sequenceName = "SEQ_PP_CONFIGURATION_PRODUCTMASTERDATA_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "productMasterDataGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "ProductMasterData {" + "id='" + id + '\'' + ", materialCode='" + materialCode + '\'' + ", grade='"
				+ grade + '\'' + ", color='" + color + '\'' + ", description='" + description + '\'' + ", version='"

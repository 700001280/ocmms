...
public class Region implements Serializable {
	...
	public String toString() {
		return "Region {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", version='" + version + '\''
	 ...
	 */
	public void addToProvinces(Iterable<Province> provincesToAdd) {
	 ...
	 */
	public void removeFromProvinces(Iterable<Province> provincesToRemove) {

...
/**
 * = PreventiveMaintenanceType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_PLAN_PREVENTIVEMAINTENANCETYPE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PreventiveMaintenanceType implements Serializable {
	...
	public String toString() {
		return "PreventiveMaintenanceType {" + "id='" + id + '\'' + ", type='" + type + '\'' + ", description='"

...
/**
 * = LotoInfo TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_LOTOINFO")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class LotoInfo implements Serializable {
	...
	public String toString() {
		return "LotoInfo {" + "id='" + id + '\'' + ", lotoTag='" + lotoTag + '\'' + ", description='" + description
				+ '\'' + ", note='" + note + '\'' + ", nextAuditDate='" + nextAuditDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(nextAuditDate.getTime()) + '\''
								+ ", barUrl='" + barUrl + '\'' + ", version='" + version + '\'' + ", createdDate='"
								+ createdDate == null
										? null
	 ...
	 */
	public void addToLotoDetails(Iterable<LotoDetail> lotoDetailsToAdd) {
	 ...
	 */
	public void removeFromLotoDetails(Iterable<LotoDetail> lotoDetailsToRemove) {
	 ...
	 */
	public void addToLotoIssueReports(Iterable<LotoIssueReport> lotoIssueReportsToAdd) {
	 ...
	 */
	public void removeFromLotoIssueReports(Iterable<LotoIssueReport> lotoIssueReportsToRemove) {

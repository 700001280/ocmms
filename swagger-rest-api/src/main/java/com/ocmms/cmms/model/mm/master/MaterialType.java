...
@Entity
@Table(name = "MM_MASTER_MATERIALTYPE")
...
public class MaterialType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "materialTypeGen", sequenceName = "SEQ_MM_MASTER_MATERIALTYPE_ID")
	...
	public String toString() {
		return "MaterialType {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", type='" + type + '\''

...
/**
 * = LotoIssueReport TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_ISSUEREPORT")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class LotoIssueReport implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "LotoIssueReportGen", sequenceName = "SEQ_LOTO_ISSUEREPORT_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "LotoIssueReportGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "lotoIssueReport")
	...
	public String toString() {
		return "LotoIssueReport {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", version='"

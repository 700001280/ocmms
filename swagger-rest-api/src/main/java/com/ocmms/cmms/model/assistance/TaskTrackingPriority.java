...
/**
 * = TaskTrackingPriority TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "ASSISTANCE_TASKTRACKINGPRIORITY")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class TaskTrackingPriority implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "taskTrackingPriorityGen", sequenceName = "SEQ_ASSISTANCE_TASKTRACKINGPRIORITY_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taskTrackingPriorityGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 */
	@NotNull
	@Column(name = "PRIORITY", unique = true, length = 20)
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "taskTrackingPriority")
	...
	public String toString() {
		return "TaskTrackingPriority {" + "id='" + id + '\'' + ", priority='" + priority + '\'' + ", description='"

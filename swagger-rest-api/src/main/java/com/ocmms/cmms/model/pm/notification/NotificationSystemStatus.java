...
/**
 * = NotificationSystemStatus TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_SYSTEMSTATUS")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class NotificationSystemStatus implements Serializable {
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "systemStatus")
	...
	public String toString() {
		return "NotificationSystemStatus {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='"

...
/**
 * = MeasuringPoint TODO Auto-generated class documentation
 *
 */
@Data
...
public class MeasuringPoint implements Serializable {
	...
	public String toString() {
		return "MeasuringPoint {" + "id='" + id + '\'' + ", measuringTag='" + measuringTag + '\'' + ", description='"
				+ description + '\'' + ", lowLimit='" + lowLimit + '\'' + ", upperLimit='" + upperLimit + '\''
				+ ", lowAlarm='" + lowAlarm + '\'' + ", upperAlarm='" + upperAlarm + '\'' + ", lowInterlock='"
				+ lowInterlock + '\'' + ", upperInterlock='" + upperInterlock + '\'' + ", version='" + version + '\''

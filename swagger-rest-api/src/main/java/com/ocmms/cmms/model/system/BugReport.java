...
/**
 * = BugReport TODO Auto-generated class documentation
 *
 */
@Data
...
public class BugReport implements Serializable {
	...
	public String toString() {
		return "BugReport {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", title='" + title + '\''
				+ ", submitDate='" + submitDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(submitDate.getTime()) + '\'' + ", solved='"
								+ solved + '\'' + ", closeDescription='" + closeDescription + '\'' + ", solvedDate='"
								+ solvedDate == null
										? null
										: java.text.DateFormat.getDateTimeInstance().format(solvedDate.getTime()) + '\''
												+ ", pics='" + pics + '\'' + ", version='" + version + '\''

...
/**
 * = PotentialHazard TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_POTENTIALHAZARD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PotentialHazard implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "PotentialHazardGen", sequenceName = "SEQ_LOTO_POTENTIALHAZARD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PotentialHazardGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "PotentialHazard {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

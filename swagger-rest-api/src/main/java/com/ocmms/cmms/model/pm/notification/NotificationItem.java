...
/**
 * = NotificationItem TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_ITEM")
...
public class NotificationItem implements Serializable {
	...
	public String toString() {
		return "NotificationItem {" + "id='" + id + '\'' + ", failureDescription='" + failureDescription + '\''
				+ ", activity='" + activity + '\'' + ", executionFactor='" + executionFactor + '\''
				+ ", causeOfDamage='" + causeOfDamage + '\'' + ", memo='" + memo + '\'' + ", version='" + version + '\''

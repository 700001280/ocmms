...
/**
 * = StorageType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_STORAGE_STORAGETYPE")
...
public class StorageType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "storageTypeGen", sequenceName = "SEQ_MM_STORAGE_STORAGETYPE_ID")
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "storageType")
	...
	public String toString() {
		return "StorageType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", memo='" + memo + '\''

...
/**
 * = MovementType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_STORAGE_MOVEMENTTYPE")
...
public class MovementType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "movementTypeGen", sequenceName = "SEQ_MM_STORAGE_MOVEMENTTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "movementTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "movementType")
	...
	public String toString() {
		return "MovementType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", memo='" + memo + '\''

...
/**
 * = ProcurementOrderFinanceTracking TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_PROCUREMENT_POFINANCETRACKING")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class ProcurementOrderFinanceTracking implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "poFinanceTrackingGen", sequenceName = "SEQ_MM_PROCUREMENT_POFINANCETRACKING_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "poFinanceTrackingGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 *
	 */
	@Column(name = "PAYMENTSUBMITDATE")
	@Temporal(TemporalType.TIMESTAMP)
	@DateTimeFormat(style = "M-")
	private Calendar paymentSubmitDate;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "procurementOrderFinanceTracking")
	...
	public String toString() {
		return "ProcurementOrderFinanceTracking {" + "id='" + id + '\'' + ", invoiceReceived='" + invoiceReceived + '\''
				+ ", paymentSubmit='" + paymentSubmit + '\'' + ", paymentSubmitDate='" + paymentSubmitDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(paymentSubmitDate.getTime()) + '\''

...
/**
 * = WorkOrderMaterial TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_WORKORDER_MATERIAL")
...
public class WorkOrderMaterial implements Serializable {
	...
	public String toString() {
		return "WorkOrderMaterial {" + "id='" + id + '\'' + ", quantity='" + quantity + '\'' + ", partName='" + partName

...
/**
 * = MailTemplateDefinition TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "SYSTEM_MAILTEMPLATEDEFINITION")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class MailTemplateDefinition implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "mailTemplateDefinitionGen", sequenceName = "SEQ_SYSTEM_MAILTEMPLATEDEFINITION_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "mailTemplateDefinitionGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 */
	@NotNull
	@Column(name = "TORECEIVERS", unique = true)
	 ...
	 */
	@NotNull
	@Column(name = "CCRECEIVERS", unique = true)
	...
	public String toString() {
		return "MailTemplateDefinition {" + "id='" + id + '\'' + ", template='" + template + '\'' + ", className='"
				+ className + '\'' + ", description='" + description + '\'' + ", title='" + title + '\''
				+ ", toReceivers='" + toReceivers + '\'' + ", ccReceivers='" + ccReceivers + '\'' + ", receiverName='"
				+ receiverName + '\'' + ", systemDefault='" + systemDefault + '\'' + ", version='" + version + '\''

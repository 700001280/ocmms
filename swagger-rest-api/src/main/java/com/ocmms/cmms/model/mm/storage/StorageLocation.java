...
@Entity
@Table(name = "MM_STORAGE_STORAGELOCATION")
...
public class StorageLocation implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "storageLocationGen", sequenceName = "SEQ_MM_STORAGE_STORAGELOCATION_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "storageLocationGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "storageLocation")
	...
	public String toString() {
		return warehouse.toString()+"-"+location;
	}

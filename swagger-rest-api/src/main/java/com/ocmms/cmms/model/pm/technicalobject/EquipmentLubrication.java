...
/**
 * = EquipmentLubrication TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TECHNICALOBJECT_EQUIPMENTLUBRICATION")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class EquipmentLubrication implements Serializable {
	...
	public String toString() {
		return "EquipmentLubrication {" + "id='" + id + '\'' + ", fillQuantity='" + fillQuantity + '\'' + ", lubPoint='"
				+ lubPoint + '\'' + ", intervalCycle='" + intervalCycle + '\'' + ", runtimeCycle='" + runtimeCycle

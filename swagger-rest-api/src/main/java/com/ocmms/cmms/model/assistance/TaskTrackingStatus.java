...
/**
 * = TaskTrackingStatus TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "ASSISTANCE_TASKTRACKINGSTATUS")
...
public class TaskTrackingStatus implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "taskTrackingStatusGen", sequenceName = "SEQ_ASSISTANCE_TASKSTRACKINGTATUS_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taskTrackingStatusGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "taskTrackingStatus")
	...
	public String toString() {
		return "TaskTrackingStatus {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

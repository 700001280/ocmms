...
/**
 * = PreventiveMaintenanceExecution TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_PM_PREVENTIVEMAINTENANCEEXECUTION")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PreventiveMaintenanceExecution implements Serializable {
	...
	public String toString() {
		return "PreventiveMaintenanceExecution {" + "id='" + id + '\'' + ", description='" + description + '\''
				+ ", startDate='" + startDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(startDate.getTime()) + '\''
								+ ", completeDate='" + completeDate == null
										? null
										: java.text.DateFormat.getDateTimeInstance().format(completeDate.getTime())

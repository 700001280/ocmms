...
/**
 * = ProcurementOrder TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_PROCUREMENT_ORDER")
...
public class ProcurementOrder implements Serializable {
	...
	public String toString() {
		return "ProcurementOrder {" + "id='" + id + '\'' + ", orderDate='" + orderDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(orderDate.getTime()) + '\'' + ", orderNumber='"
						+ orderNumber + '\'' + ", memo='" + memo + '\'' + ", closed='" + closed + '\'' + ", version='"
								...
								: java.text.DateFormat.getDateTimeInstance().format(createdDate.getTime()) + '\''
										...
										+ lastModifiedDate == null
												...
												: java.text.DateFormat.getDateTimeInstance().format(
														lastModifiedDate.getTime()) + '\'' + ", lastModifiedBy='"
														+ lastModifiedBy + '\'' + "}" + super.toString();
	}
	 ...
	 */
	public void addToPurchaseExpedites(Iterable<PurchaseExpedite> purchaseExpeditesToAdd) {
	 ...
	 */
	public void removeFromPurchaseExpedites(Iterable<PurchaseExpedite> purchaseExpeditesToRemove) {
	 ...
	 */
	public void addToProcurementOrderFinanceTrackings(
			Iterable<ProcurementOrderFinanceTracking> procurementOrderFinanceTrackingsToAdd) {
	 ...
	 */
	public void removeFromProcurementOrderFinanceTrackings(
			Iterable<ProcurementOrderFinanceTracking> procurementOrderFinanceTrackingsToRemove) {
	 ...
	 */
	public void addToPocurementItemDetails(Iterable<ProcurementItemDetail> pocurementItemDetailsToAdd) {
	 ...
	 */
	public void removeFromPocurementItemDetails(Iterable<ProcurementItemDetail> pocurementItemDetailsToRemove) {

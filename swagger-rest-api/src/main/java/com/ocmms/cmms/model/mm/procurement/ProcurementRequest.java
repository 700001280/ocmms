...
/**
 * = ProcurementRequest TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_PROCUREMENT_REQUEST")
...
public class ProcurementRequest implements Serializable {
	...
	public String toString() {
		return "ProcurementRequest {" + "id='" + id + '\'' + ", submitDate='" + submitDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(submitDate.getTime()) + '\'' + ", requestDate='"
						+ requestDate == null
								? null
								: java.text.DateFormat.getDateTimeInstance().format(requestDate.getTime()) + '\''
										+ ", requestNumber='" + requestNumber + '\'' + ", memo='" + memo + '\''

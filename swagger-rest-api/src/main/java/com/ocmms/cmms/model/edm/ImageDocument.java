...
/**
 * = ImageDocument TODO Auto-generated class documentation
 *
 */
@Data
...
public class ImageDocument implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "imageDocumentGen", sequenceName = "SEQ_EDM_IMAGEDOCUMENT_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "imageDocumentGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 *
	 */
	@Column(columnDefinition = "LONGTEXT", name = "IMAGEENCODE")
	...
	public String toString() {
		return "ImageDocument {" + "id='" + id + '\'' + ", fileName='" + fileName + '\'' + ", description='"
				+ description + '\'' + ", fileType='" + fileType + '\'' + ", imageEncode='" + imageEncode + '\''

...
/**
 * = FailureObjectPart TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_FAILUREOBJECTPART")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class FailureObjectPart implements Serializable {
	...
	public String toString() {
		return "FailureObjectPart {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description
				+ '\'' + ", groupCode='" + groupCode + '\'' + ", groupDescription='" + groupDescription + '\''
				+ ", subCode='" + subCode + '\'' + ", subDescription='" + subDescription + '\'' + ", version='"

...
/**
 * = BarcodeDefinition TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "SYSTEM_BARCODEDEFINITION")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class BarcodeDefinition implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "barcodeDefinitionGen", sequenceName = "SEQ_BARCODE_DEFINITION_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "barcodeDefinitionGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "BarcodeDefinition {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", className='" + className

...
/**
 * = EquipmentStatus TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TECHNICALOBJECT_EQUIPMENTSTATUS")
...
public class EquipmentStatus implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "equipmentStatusGen", sequenceName = "SEQ_PM_EQUIPMENTSTATUS_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipmentStatusGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "EquipmentStatus {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

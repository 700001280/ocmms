...
/**
 * = OutstockDetail TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_STORAGE_OUTSTOCKDETAIL")
...
public class OutstockDetail implements Serializable {
	...
	public String toString() {
		return "OutstockDetail {" + "id='" + id + '\'' + ", serialNumber='" + serialNumber + '\''
				+ ", outstockQuantity='" + outstockQuantity + '\'' + ", issueDate='" + issueDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(issueDate.getTime()) + '\'' + ", memo='"
								+ memo + '\'' + ", version='" + version + '\'' + ", createdDate='" + createdDate == null
										? null

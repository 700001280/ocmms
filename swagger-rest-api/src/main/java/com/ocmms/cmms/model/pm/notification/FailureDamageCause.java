...
/**
 * = FailureDamageCause TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_FAILUREDAMAGECAUSE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class FailureDamageCause implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "failureDamageCauseGen", sequenceName = "SEQ_PM_NOTIFICATION_FAILUREDAMAGECAUSE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "failureDamageCauseGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "FailureDamageCause {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description
				+ '\'' + ", groupCode='" + groupCode + '\'' + ", groupDescription='" + groupDescription + '\''
				+ ", subCode='" + subCode + '\'' + ", subDescription='" + subDescription + '\'' + ", explanation='"
				+ explanation + '\'' + ", version='" + version + '\'' + ", createdDate='" + createdDate == null
						? null

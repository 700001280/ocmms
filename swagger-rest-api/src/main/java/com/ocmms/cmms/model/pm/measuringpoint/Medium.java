...
/**
 * = Medium TODO Auto-generated class documentation
 *
 */
@Data
...
public class Medium implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "mediumGen", sequenceName = "SEQ_PM_MEDIUM_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "mediumGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "Medium {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''

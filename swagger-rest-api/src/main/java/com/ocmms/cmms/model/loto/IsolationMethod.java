...
/**
 * = IsolationMethod TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_ISOLATIONMETHOD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class IsolationMethod implements Serializable {
	...
	public String toString() {
		return "IsolationMethod {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

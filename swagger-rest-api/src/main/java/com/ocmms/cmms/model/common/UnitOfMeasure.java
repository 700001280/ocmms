...
/**
 * = UnitOfMeasure TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "COMMON_UNITOFMEASURE")
...
public class UnitOfMeasure implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "unitOfMeasureGen", sequenceName = "SEQ_COMMON_UNITOFMEASURE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "unitOfMeasureGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "UnitOfMeasure {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

...
/**
 * = PlanPeriod TODO Auto-generated class documentation
 *
 */
@Data
...
public class PlanPeriod implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "periodGen", sequenceName = "SEQ_PM_PLAN_PERIOD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "periodGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "PlanPeriod {" + "id='" + id + '\'' + ", period='" + period + '\'' + ", description='" + description

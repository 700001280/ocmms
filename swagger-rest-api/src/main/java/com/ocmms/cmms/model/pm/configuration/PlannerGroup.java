...
/**
 * = PlannerGroup TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_PLANNERGROUP")
...
public class PlannerGroup implements Serializable {
	...
	public String toString() {
		return "PlannerGroup {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''
				+ ", phoneNumber='" + phoneNumber + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

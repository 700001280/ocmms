...
/**
 * = SortField TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_SORTFIELD")
...
public class SortField implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "sortFieldGen", sequenceName = "SEQ_PM_CONFIGURATION_SORTFIELD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sortFieldGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "SortField {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''

...
/**
 * = LotoDeviceType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_LOTODEVICETYPE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class LotoDeviceType implements Serializable {
	...
	public String toString() {
		return "LotoDeviceType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

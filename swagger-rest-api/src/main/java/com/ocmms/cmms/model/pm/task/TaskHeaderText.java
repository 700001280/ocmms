...
/**
 * = TaskHeaderText TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TASK_HEADERTEXT")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class TaskHeaderText implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "taskHeaderTextGen", sequenceName = "SEQ_PM_TASK_HEADERTEXT_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taskHeaderTextGen")
	@Column(name = "ID")
	private Long id;
	...
	@NotNull
	@Column(name = "TASKHEADERTEXTCODE", unique = true)
	private String taskHeaderTextCode;

	@NotNull
	@Column(name = "COUNTERLINE")
	private Integer counterLine;

	@NotNull
	@Column(name = "HEADERTEXTTITLE", length = 40)
	...
	public String toString() {
		return "TaskHeaderText {" + "id='" + id + '\'' + ", taskHeaderTextCode='" + taskHeaderTextCode + '\''
				+ ", counterLine='" + counterLine + '\'' + ", headerTextTitle='" + headerTextTitle + '\''

...
/**
 * = PurchaseExpedite TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "MM_PROCUREMENT_PURCHASEEXPEDITE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PurchaseExpedite implements Serializable {
	...
	public String toString() {
		return "PurchaseExpedite {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", memo='" + memo
				+ '\'' + ", expediteDate='" + expediteDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(expediteDate.getTime()) + '\''
								+ ", planDeliverDate='" + planDeliverDate == null
										? null
										: java.text.DateFormat.getDateTimeInstance().format(planDeliverDate.getTime())

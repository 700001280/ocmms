...
/**
 * = ProductType TODO Auto-generated class documentation
 *
 */
@Data
...
public class ProductType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "productTypeGen", sequenceName = "SEQ_PP_PRODUCTTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "productTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "productType")
	...
	public String toString() {
		return "ProductType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''

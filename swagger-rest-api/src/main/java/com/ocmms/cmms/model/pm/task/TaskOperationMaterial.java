...
/**
 * = TaskOperationMaterial TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TASK_OPERATIONNMATERIAL")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class TaskOperationMaterial implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "taskOperationnMaterialGen", sequenceName = "SEQ_PM_TASK_OPERATIONNMATERIAL_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taskOperationnMaterialGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "TaskOperationMaterial {" + "id='" + id + '\'' + ", quantity='" + quantity + '\'' + ", version='"

...
/**
 * = NotificationUserStatusWithNumber TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_USERSTATUSWITHNUMBER")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class NotificationUserStatusWithNumber implements Serializable {
	...
	public String toString() {
		return "NotificationUserStatusWithNumber {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='"

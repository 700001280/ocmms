...
/**
 * = PartScrappingRecord TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_ROUTINE_PARTSCRAPPINGRECORD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PartScrappingRecord implements Serializable {
	...
	public String toString() {
		return "PartScrappingRecord {" + "id='" + id + '\'' + ", serialNumber='" + serialNumber + '\''
				+ ", scrappingDate='" + scrappingDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(scrappingDate.getTime()) + '\''
	 ...
	 */
	public void addToPartScrappingOutstockDetails(
			Iterable<PartScrappingOutstockDetail> partScrappingOutstockDetailsToAdd) {
	 ...
	 */
	public void removeFromPartScrappingOutstockDetails(
			Iterable<PartScrappingOutstockDetail> partScrappingOutstockDetailsToRemove) {

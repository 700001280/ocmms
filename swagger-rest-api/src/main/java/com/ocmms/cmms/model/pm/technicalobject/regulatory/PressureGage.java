...
/**
 * = PressureGage TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_REGULATORY_PRESSUREGAGE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PressureGage extends TechnicalObject implements Serializable {
	...
	public String toString() {
		return "PressureGage {lastInspectionDate='" + lastInspectionDate == null ? null

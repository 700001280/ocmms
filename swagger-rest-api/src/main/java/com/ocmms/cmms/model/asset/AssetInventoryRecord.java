...
/**
 * = AssetInventoryRecord TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "AESST_INVENTORYRECORD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class AssetInventoryRecord implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "assetInventoryRecordGen", sequenceName = "SEQ_AESST_ASSETINVENTORYRECORD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "assetInventoryRecordGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 *
	 */
	@Column(name = "IDLEBEGINNINGDATE")
	@Temporal(TemporalType.TIMESTAMP)
	@DateTimeFormat(style = "MM")
	private Calendar idleBeginningDate;

	/**
	 * TODO Auto-generated attribute documentation
	 *
	 */
	@Column(name = "ROOTCAUSEREASON")
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "assetInventoryRecord")
	...
	public String toString() {
		return "AssetInventoryRecord {" + "id='" + id + '\'' + ", checkDate='" + checkDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(checkDate.getTime()) + '\'' + ", description='"
						+ description + '\'' + ", assetStatus='" + assetStatus + '\'' + ", category='" + category + '\''
						+ ", subCategory='" + subCategory + '\'' + ", sparepart='" + sparepart + '\''
						+ ", idleBeginningDate='" + idleBeginningDate == null
								? null
								: java.text.DateFormat.getDateTimeInstance().format(idleBeginningDate.getTime()) + '\''
										+ ", rootCauseReason='" + rootCauseReason + '\'' + ", actionPlan='" + actionPlan
										+ '\'' + ", checkResult='" + checkResult + '\'' + ", version='" + version + '\''
										+ ", createdDate='" + createdDate == null
												? null
												: java.text.DateFormat.getDateTimeInstance().format(
														createdDate.getTime()) + '\'' + ", createdBy='" + createdBy
	...
	public void addToDocuments(Iterable<Document> documentsToAdd) {
		...
		for (Document item : documentsToAdd) {
			...
			item.setAssetInventoryRecord(this);
		}
	}

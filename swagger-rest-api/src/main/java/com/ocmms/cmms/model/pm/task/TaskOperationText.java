...
/**
 * = TaskOperationText TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TASK_OPERATIONTEXT")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class TaskOperationText implements Serializable {
	...
	public String toString() {
		return "TaskOperationText {" + "id='" + id + '\'' + ", taskOperationTextCode='" + taskOperationTextCode + '\''
				+ ", operationTextNumber='" + operationTextNumber + '\'' + ", operationShortText='" + operationShortText

...
@Entity
@Table(name = "MM_MASTER_MROCATALOG")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class MROCatalog implements Serializable {
	...
	public String toString() {
		return "MROCatalog {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", materialName='" + materialName + '\''
				+ ", materialGroup='" + materialGroup + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

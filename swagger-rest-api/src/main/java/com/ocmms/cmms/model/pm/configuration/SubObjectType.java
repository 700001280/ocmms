...
/**
 * = SubObjectType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_SUBOBJECTTYPE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class SubObjectType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "subObjectTypeGen", sequenceName = "SEQ_PM_CONFIGURATION_SUBOBJECTTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "subObjectTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "SubObjectType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

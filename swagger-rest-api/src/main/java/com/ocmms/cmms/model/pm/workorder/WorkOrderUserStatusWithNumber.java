...
/**
 * = WorkOrderUserStatusWithNumber TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_WORKORDER_USERSTATUSWITHNUMBER")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class WorkOrderUserStatusWithNumber implements Serializable {
	...
	public String toString() {
		return "WorkOrderUserStatusWithNumber {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='"
				+ description + '\'' + ", status='" + status + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

...
/**
 * = TreeMenu TODO Auto-generated class documentation
 *
 */
@Data
...
public class TreeMenu implements Serializable {
	...
	public String toString() {
		return "TreeMenu {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", urlLink='" + urlLink
				+ '\'' + ", visible='" + visible + '\'' + ", loginRoles='" + loginRoles + '\'' + ", version='" + version

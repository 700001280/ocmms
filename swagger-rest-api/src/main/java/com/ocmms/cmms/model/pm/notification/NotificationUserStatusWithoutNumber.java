...
/**
 * = NotificationUserStatusWithoutNumber TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_USERSTATUSWITHOUTNUMBER")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class NotificationUserStatusWithoutNumber implements Serializable {
	...
	public String toString() {
		return "NotificationUserStatusWithoutNumber {" + "id='" + id + '\'' + ", code='" + code + '\''

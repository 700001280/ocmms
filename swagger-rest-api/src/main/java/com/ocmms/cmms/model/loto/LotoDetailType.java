...
/**
 * = LotoDetailType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_LOTODETAILTYPE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class LotoDetailType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "LotoDetailTypeGen", sequenceName = "SEQ_LOTO_LOTODETAILTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "LotoDetailTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "LotoDetailType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

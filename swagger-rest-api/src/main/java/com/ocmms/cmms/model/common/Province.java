...
/**
 * = Province TODO Auto-generated class documentation
 *
 */
@Data
...
public class Province implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "ProvinceGen", sequenceName = "SEQ_COMMON_PROVINCE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ProvinceGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "province")
	...
	public String toString() {
		return "Province {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", version='" + version

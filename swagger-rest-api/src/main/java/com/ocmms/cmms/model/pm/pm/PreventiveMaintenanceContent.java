...
/**
 * = PreventiveMaintenanceContent TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_PM_PREVENTIVEMAINTENANCECONTENT")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class PreventiveMaintenanceContent implements Serializable {
	...
	public String toString() {
		return "PreventiveMaintenanceContent {" + "id='" + id + '\'' + ", serialNo='" + serialNo + '\''
				+ ", description='" + description + '\'' + ", method='" + method + '\'' + ", standard='" + standard
				+ '\'' + ", tool='" + tool + '\'' + ", startDate='" + startDate == null
						? null
						: java.text.DateFormat.getDateTimeInstance().format(startDate.getTime()) + '\''
								+ ", singleCycle='" + singleCycle + '\'' + ", version='" + version + '\''

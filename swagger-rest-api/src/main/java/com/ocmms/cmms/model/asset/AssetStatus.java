...
/**
 * = AssetStatus TODO Auto-generated class documentation
 *
 */
@Data
...
public class AssetStatus implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "assetStatusGen", sequenceName = "SEQ_ASSET_ASSETSTATUS_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "assetStatusGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "assetStatus")
	...
	public String toString() {
		return "AssetStatus {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description + '\''
				+ ", status='" + status + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

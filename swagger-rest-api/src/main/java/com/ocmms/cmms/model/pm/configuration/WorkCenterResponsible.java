...
/**
 * = WorkCenterResponsible TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_WORKCENTERRESPONSIBLE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class WorkCenterResponsible implements Serializable {
	...
	public String toString() {
		return "WorkCenterResponsible {" + "id='" + id + '\'' + ", responsible='" + responsible + '\''
				+ ", description='" + description + '\'' + ", version='" + version + '\'' + ", createdDate='"
				+ createdDate == null
						? null

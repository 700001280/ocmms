...
/**
 * = EquipmentScrappingRecord TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_ROUTINE_EQUIPMENTSCRAPPINGRECORD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class EquipmentScrappingRecord implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "equipmentScrappingRecordGen", sequenceName = "SEQ_PM_ROUTINE_EQUIPMENTSCRAPPINGRECORD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "equipmentScrappingRecordGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "equipmentScrappingRecord")
	...
	public String toString() {
		return "EquipmentScrappingRecord {" + "id='" + id + '\'' + ", scrappingDate='" + scrappingDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(scrappingDate.getTime()) + '\'' + ", description='"
						+ description + '\'' + ", location='" + location + '\'' + ", version='" + version + '\''

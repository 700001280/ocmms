...
/**
 * = SystemCondition TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TECHNICALOBJECT_SYSTEMCONDITION")
...
public class SystemCondition implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "systemConditionGen", sequenceName = "SEQ_PM_TECHNICALOBJECT_SYSTEMCONDITION_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "systemConditionGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "systemCondition")
	...
	public String toString() {
		return "SystemCondition {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

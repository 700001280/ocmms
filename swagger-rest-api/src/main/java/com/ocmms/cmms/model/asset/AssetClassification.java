...
/**
 * = AssetClassification TODO Auto-generated class documentation
 *
 */
@Data
...
public class AssetClassification implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "AssetClassificationGen", sequenceName = "SEQ_ASSET_CLASSIFICATION_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "AssetClassificationGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "assetClassification")
	...
	public String toString() {
		return "AssetClassification {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

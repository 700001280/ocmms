...
/**
 * = PlantSection TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_PLANTSECTION")
...
public class PlantSection implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "plantSectionGen", sequenceName = "SEQ_PM_CONFIGURATION_PLANTSECTION_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "plantSectionGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 */
	@NotNull
	@Column(name = "SECTIONPHONENUMBER")
	private String sectionPhoneNumber;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "plantSection")
	...
	public String toString() {
		return "PlantSection {" + "id='" + id + '\'' + ", description='" + description + '\'' + ", section='" + section
				+ '\'' + ", sectionPhoneNumber='" + sectionPhoneNumber + '\'' + ", version='" + version + '\''

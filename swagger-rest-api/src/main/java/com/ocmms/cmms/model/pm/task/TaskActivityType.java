...
/**
 * = TaskActivityType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_TASK_ACTIVITYTYPE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class TaskActivityType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "activityTypeGen", sequenceName = "SEQ_PM_TASK_ACTIVITYTYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "activityTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "TaskActivityType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

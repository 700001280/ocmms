...
/**
 * = MeasuringRecord TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_MEASURINGRECORD")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class MeasuringRecord implements Serializable {
	...
	public String toString() {
		return "MeasuringRecord {" + "id='" + id + '\'' + ", measuringDate='" + measuringDate == null ? null
				: java.text.DateFormat.getDateTimeInstance().format(measuringDate.getTime()) + '\''
						+ ", measuringValue='" + measuringValue + '\'' + ", description='" + description + '\''
						+ ", dcsValue='" + dcsValue + '\'' + ", version='" + version + '\'' + ", createdDate='"
						+ createdDate == null
								? null

...
/**
 * = AuthourizationGroup TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_PLAN_AUTHOURIZATIONGROUP")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class AuthourizationGroup implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "authourizationGroupGen", sequenceName = "SEQ_PM_PLAN_AUTHOURIZATIONGROUP_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "authourizationGroupGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "AuthourizationGroup {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

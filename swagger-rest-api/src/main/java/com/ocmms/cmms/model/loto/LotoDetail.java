...
/**
 * = LotoDetail TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "LOTO_LOTODETAIL")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class LotoDetail implements Serializable {
	...
	public String toString() {
		return "LotoDetail {" + "id='" + id + '\'' + ", source='" + source + '\'' + ", sourceTag='" + sourceTag + '\''
				+ ", device='" + device + '\'' + ", location='" + location + '\'' + ", method='" + method + '\''
				+ ", verification='" + verification + '\'' + ", returnServiceOrder='" + returnServiceOrder + '\''
				+ ", note='" + note + '\'' + ", version='" + version + '\'' + ", createdDate='" + createdDate == null
						? null

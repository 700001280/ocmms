...
/**
 * = OperationRelationship TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_CONFIGURATION_OPERATIONRELATIONSHIP")
...
public class OperationRelationship implements Serializable {
	...
	public String toString() {
		return "OperationRelationship {" + "id='" + id + '\'' + ", type='" + type + '\'' + ", description='"

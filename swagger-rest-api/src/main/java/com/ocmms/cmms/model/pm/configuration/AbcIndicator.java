...
@Entity
@Table(name = "PM_CONFIGURATION_ABCINDICATOR")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class AbcIndicator implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "abcIndicatorGen", sequenceName = "SEQ_PM_CONFIGURATION_ABCINDICATOR_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "abcIndicatorGen")
	@Column(name = "ID")
	private Long id;
	 ...
	 */
	@NotNull
	@Column(name = "RISKLEVEL", unique = true)
	 ...
	 */
	@NotNull
	@Column(name = "INDICATOR", unique = true, length = 1)
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "abcIndicator")
	...
	public String toString() {
		return "AbcIndicator {" + "id='" + id + '\'' + ", riskLevel='" + riskLevel + '\'' + ", description='"
				+ description + '\'' + ", status='" + status + '\'' + ", indicator='" + indicator + '\'' + ", version='"

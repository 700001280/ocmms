...
/**
 * = FailureDamageType TODO Auto-generated class documentation
 *
 */
@Data
...
@Entity
@Table(name = "PM_NOTIFICATION_FAILUREDAMAGETYPE")
//@JsonIgnoreProperties({ "hibernateLazyInitializer" })
public class FailureDamageType implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "failureDamageTypeGen", sequenceName = "SEQ_PM_NOTIFICATION_FAILUREDAMAGETYPE_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "failureDamageTypeGen")
	@Column(name = "ID")
	private Long id;
	...
	public String toString() {
		return "FailureDamageType {" + "id='" + id + '\'' + ", code='" + code + '\'' + ", description='" + description

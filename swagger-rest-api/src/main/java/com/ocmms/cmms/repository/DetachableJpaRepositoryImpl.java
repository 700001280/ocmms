...
import com.ocmms.cmms.repository.DetachableJpaRepository;
 ...
 */
public class DetachableJpaRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID>
		implements DetachableJpaRepository<T, ID> {

	private final EntityManager entityManager;

	/**
	 * Creates a new {@link DetachableJpaRepositoryImpl} to manage objects of the
	 * given {@link JpaEntityInformation}.
	 * 

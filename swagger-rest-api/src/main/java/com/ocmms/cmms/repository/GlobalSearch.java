...
/**
 * Defines a global text search. This Value Object is used to define global data
 * searches in an entity or group of entities to validate whether any or some of
 * the data of the entity meet the search.
 *
...
public final class GlobalSearch {
	 ...
	 * @param regexp indicates if the text provided is a regular expression, or just
	 *               a text to find
	 */
	...
	/**
	 * Create a new search instance of global text by values that contains the
	 * provided text.
	 *
	...
	/**
	 * Indicates if the search text is a regular expression or just text to search.
	 *

...
/**
 * = ImageDocumentRepository TODO Auto-generated class documentation
 *
 */

@Transactional(readOnly = true)
@RepositoryRestResource(collectionResourceRel = "imagedocument", path = "imagedocument")
public interface ImageDocumentRepository extends  ImageDocumentRepositoryCustom,
		PagingAndSortingRepository<ImageDocument, Long>  {

...
import com.ocmms.cmms.conversion.DateFormatter;
import com.ocmms.cmms.conversion.UsersFormatter;
...
class WebMvcConfig extends WebMvcConfigurationSupport {
	...
	public void addFormatters(final FormatterRegistry registry) {
		...
		registry.addFormatter(usersFormatter());
		registry.addFormatter(dateFormatter());
	}

	@Bean
	public UsersFormatter usersFormatter() {

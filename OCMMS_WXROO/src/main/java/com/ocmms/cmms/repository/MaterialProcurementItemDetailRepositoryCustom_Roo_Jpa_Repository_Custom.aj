...
privileged aspect MaterialProcurementItemDetailRepositoryCustom_Roo_Jpa_Repository_Custom {
     ...
     * @return Page
     */
    public abstract Page<MaterialProcurementItemDetail> MaterialProcurementItemDetailRepositoryCustom.findByWorkOrderMaterial(WorkOrderMaterial workOrderMaterial, GlobalSearch globalSearch, Pageable pageable);
     ...
     * @return Page
     */
    public abstract Page<MaterialProcurementItemDetail> MaterialProcurementItemDetailRepositoryCustom.findAll(GlobalSearch globalSearch, Pageable pageable);
     ...
     * @return Page
     */
    public abstract Page<MaterialProcurementItemDetail> MaterialProcurementItemDetailRepositoryCustom.findAllByIdsIn(List<Long> ids, GlobalSearch globalSearch, Pageable pageable);

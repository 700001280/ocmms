...
/**
 * Single cycle and strategy plans can be either created as time or performance
 * based plans and multiple counter plans can use a combination of both time and
 * counters.
 *
 * PS01("Single Cycle Plans", 1), PS02("Strategy Plans", 2), PS03("Multiple
 * counter plans", 3);
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_PLAN_STRATEGY", entityFormatMessage = "entity_format_message_pm_plan_strategy")
...
public class PlanStrategy {
     ...
     */
    @Id
    @SequenceGenerator(name = "planStrategyGen", sequenceName = "SEQ_PM_PLAN_STRATEGY_ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "planStrategyGen")
    @Column(name = "ID")
    private Long id;

...
/**
 * = OrganizationCatalog Define the Organization type
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "HRM_ORGANIZATIONCATALOG", entityFormatMessage = "entity_format_message_hrm_organizationcatalog")
...
public class OrganizationCatalog {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "organizationCatalogGen", sequenceName = "SEQ_HRM_ORGANIZATIONCATALOG_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "organizationCatalogGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "organizationCatalog")

...
/**
 * = Address <br>
 * Common information for all related class which need the address.
 *
 */
@RooJavaBean 
@RooToString
@RooJpaEntity(table = "COMMON_ADDRESS", entityFormatMessage = "entity_format_message_common_address")
...
public class Address {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "AddressGen", sequenceName = "SEQ_COMMON_ADDRESS_ID")

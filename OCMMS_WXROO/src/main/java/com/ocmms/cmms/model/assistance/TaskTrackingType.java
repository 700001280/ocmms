...
/**
 * = TaskType TODO Auto-generated class documentation
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "ASSISTANCE_TASKTRACKINGTYPE", entityFormatMessage = "entity_format_message_task_trackingtype")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class TaskTrackingType {

...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_PM_PREVENTIVEMAINTENANCECONTENT", entityFormatMessage = "entity_format_message_pm_pm_preventivemaintenancecontent")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class PreventiveMaintenanceContent {
     ...
     */
    @Id
    @SequenceGenerator(name = "PreventiveMaintenanceContentGen", sequenceName = "SEQ_PM_PM_PREVENTIVEMAINTENANCECONTENT_ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PreventiveMaintenanceContentGen")
    @Column(name = "ID")
    private Long id;
    ...
    @OneToMany(cascade = {javax.persistence.CascadeType.MERGE,
        javax.persistence.CascadeType.PERSIST}, fetch = FetchType.LAZY, mappedBy = "preventiveMaintenanceContent")

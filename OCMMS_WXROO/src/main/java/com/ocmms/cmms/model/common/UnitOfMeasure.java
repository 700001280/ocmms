...
/**
 * = Unit TODO Auto-generated class documentation
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "COMMON_UNITOFMEASURE", entityFormatMessage = "entity_format_message_assistance_common_unitofmeasure")

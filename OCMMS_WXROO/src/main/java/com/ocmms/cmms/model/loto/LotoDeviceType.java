 ...
 * LOTO锁定工具类型如下<BR>
 * Padlock<br>
 * Wall Switch Device<br>
 * Universal Plug Device<br>
 * Ball Valve Device<br>
 * Gate Valve Device<br>
 * Breaker Device<br>
 * Cable Device<br>
 * Quick Disconnect Device<br>
 * Flange<br>
 * Cap<br>
 *
 * 
...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "LOTO_LOTODEVICETYPE", entityFormatMessage = "entity_format_message_loto_lotodevicetype")
@RooEquals(isJpaEntity = true)
@RooSerializable
@RooJpaAudit
public class LotoDeviceType {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "LotoDeviceTypeGen", sequenceName = "SEQ_LOTO_ISOLATIONMETHOD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "LotoDeviceTypeGen")
	@Column(name = "ID")
	private Long id;

...
@RooJavaBean 
@RooToString
@RooJpaEntity(table = "SYSTEM_RECORDSTATUS", entityFormatMessage = "entity_format_message_system_recordstatus")
...
public class RecordStatus {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "RecordStatusGen", sequenceName = "SEQ_RECORDSTATUS_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "RecordStatusGen")
	@Column(name = "ID")
	private Long id;

...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "ASSET_ASSETSTATUSCHANGERECORD", entityFormatMessage = "entity_format_message_asset_assetstatuschangerecord")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class AssetStatusChangeRecord {

...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_TECHNICALOBJECT_EQUIPMENTSTATUSCHANGERECORD", entityFormatMessage = "entity_format_message_pm_technicalobject_equipmentstatuschangerecord")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class EquipmentStatusChangeRecord {

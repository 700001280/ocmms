...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_WORKORDER_USERSTATUSWITHNUMBER", entityFormatMessage = "entity_format_message_pm_workorder_userstatuswithnumber")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class WorkOrderUserStatusWithNumber {

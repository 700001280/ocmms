...
@RooJavaBean
@RooToString
@RooJpaEntity(inheritanceType = "SINGLE_TABLE", table = "MM_STORAGE_OUTSTOCKDETAIL", entityFormatMessage = "entity_format_message_mm_storage_outstockdetail")
...
public class OutstockDetail {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "outstockDetailGen", sequenceName = "SEQ_MM_STORAGE_OUTSTOCKDETAIL_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "outstockDetailGen")
	@Column(name = "ID")
	private Long id;
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "outstockDetail")

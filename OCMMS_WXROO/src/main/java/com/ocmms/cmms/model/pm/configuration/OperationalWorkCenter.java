...
/**
 * The Operational Work Center will be used to represent a person or group of
 * people that are able to perform maintenance activities. Operational Work
 * Centers will be used in capacity evaluation and also assigned to Operations
 * in: • Task Lists and • Maintenance Orders When the Operational Work Centers
 * are created: • The Basic Data, Defaults, Capacities, Scheduling, and Costing
 * tabs will be completed for the master record
 * 
 * @author qinzeyong
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_CONFIGURATION_OPERATIONALWORKCENTER", entityFormatMessage = "entity_format_message_pm_configuration_operationalworkcenter")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class OperationalWorkCenter {

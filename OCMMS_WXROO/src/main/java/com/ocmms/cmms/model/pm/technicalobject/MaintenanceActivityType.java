...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_WORKORDER_MAINTENANCEACTIVITYTYPE", entityFormatMessage = "entity_format_message_pm_workorder_maintenanceactivitytype")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class MaintenanceActivityType {

...
/**
 * = Country TODO Auto-generated class documentation
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "COMMON_COUNTRY", entityFormatMessage = "entity_format_message_common_country")
...
public class Country {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "countryGen", sequenceName = "SEQ_COMMON_COUNTRY_ID")
	...
	@OneToMany(cascade = { javax.persistence.CascadeType.MERGE,
			javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "country")

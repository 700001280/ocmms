...
/**
 * The List Editing function is used to create a list of all notifications that
 * match certain criteria selected for the search report. Most of the fields
 * within the notification can be used as selection criteria for the search.
 * 
 * @author qinzeyong
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_NOTIFICATION_SYSTEMSTATUS", entityFormatMessage = "entity_format_message_pm_notification_systemstatus")

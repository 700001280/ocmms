...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_NOTIFICATION_FAILUREDAMAGETYPE", entityFormatMessage = "entity_format_message_pm_notification_failuredamagetype")
@RooEquals(isJpaEntity = true)
@RooSerializable
@RooJpaAudit
public class FailureDamageType {

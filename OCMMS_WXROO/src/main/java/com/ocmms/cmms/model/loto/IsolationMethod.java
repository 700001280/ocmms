...
/**
 * Move disconnect to off<br>
 * Trace cord and unplug<br>
 * Move switch to off position<br>
 * Move breaker to off position<br>
 * Turn valve to closed position<br>
 * Disconnect fitting<br>
 * Disconnect all install flange<br>
 * Disconnect and install cap.<br>
 *
 * 
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "LOTO_ISOLATIONMETHOD", entityFormatMessage = "entity_format_message_loto_isolationmethod")
...
public class IsolationMethod {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "IsolationMethodGen", sequenceName = "SEQ_LOTO_ISOLATIONMETHOD_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IsolationMethodGen")
	@Column(name = "ID")
	private Long id;

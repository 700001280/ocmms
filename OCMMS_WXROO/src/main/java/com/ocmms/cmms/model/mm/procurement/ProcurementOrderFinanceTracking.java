...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "MM_PROCUREMENT_POFINANCETRACKING", entityFormatMessage = "entity_format_message_mm_procurement_pofinancetracking")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class ProcurementOrderFinanceTracking {

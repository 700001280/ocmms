...
/**
 * CRTD("Created", 1), REL("Released", 2), TECO("Technically completed", 3),
 * CLSD("Business Complete", 4), CNF("Confirmed", 4), PCNF("Partially
 * confirmed", 4), GMPS("Goods movement posted", 4), MACM("Material committed",
 * 4), MSPT("Material Shortage", 4), PRT("Printed", 4);
 * 
 * 
 * 
 * @author qinzeyong
...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_WORKORDER_SYSTEMSTATUS", entityFormatMessage = "entity_format_message_pm_workorder_systemstatus")
@RooEquals(isJpaEntity = true)
@RooSerializable
@RooJpaAudit
public class WorkOrderSystemStatus {

...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PM_NOTIFICATION_FAILUREDAMAGECAUSE", entityFormatMessage = "entity_format_message_pm_notification_failuredamagecause")
@RooEquals(isJpaEntity = true)
@RooSerializable
@RooJpaAudit
public class FailureDamageCause {

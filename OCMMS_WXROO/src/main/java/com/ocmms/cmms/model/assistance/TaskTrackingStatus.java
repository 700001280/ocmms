...
/**
 * = TaskStatus TODO Auto-generated class documentation
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "ASSISTANCE_TASKTRACKINGSTATUS", entityFormatMessage = "entity_format_message_task_trackingstatus")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class TaskTrackingStatus {

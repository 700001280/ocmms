...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "COMMON_CURRENCY", entityFormatMessage = "entity_format_message_common_currency")
...
public class Currency {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "currencyGen", sequenceName = "SEQ_COMMON_CURRENCY_ID")

...
@RooJavaBean
@RooToString
@RooJpaEntity(table = "PP_AMFINDING", entityFormatMessage = "entity_format_message_pp_amfinding")
@RooEquals(isJpaEntity = true)
@RooSerializable
@RooJpaAudit
public class AutonomousMaintenanceFinding extends NotificationHeader {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "amFindingGen", sequenceName = "SEQ_PP_AMFINDING_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "amFindingGen")
	@Column(name = "ID")
	private Long id;

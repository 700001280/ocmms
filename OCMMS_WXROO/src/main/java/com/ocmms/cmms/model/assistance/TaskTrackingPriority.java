...
/**
 * = TaskPriority Define the task priority
 *
 */
@RooJavaBean
@RooToString
@RooJpaEntity(table = "ASSISTANCE_TASKTRACKINGPRIORITY", entityFormatMessage = "entity_format_message_task_trackingpriority")
@RooEquals(isJpaEntity = true)
@RooSerializable

@RooJpaAudit
public class TaskTrackingPriority {

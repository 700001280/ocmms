...
privileged aspect RegionService_Roo_Service {
     ...
     * @return Region
     */
    public abstract Region RegionService.addToProvinces(Region region, Iterable<Long> provincesToAdd);
     ...
     * @return Region
     */
    public abstract Region RegionService.removeFromProvinces(Region region, Iterable<Long> provincesToRemove);
     ...
     * @return Region
     */
    public abstract Region RegionService.setProvinces(Region region, Iterable<Long> provinces);

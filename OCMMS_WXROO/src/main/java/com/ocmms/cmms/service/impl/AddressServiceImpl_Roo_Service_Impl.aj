...
import com.ocmms.cmms.service.impl.AddressServiceImpl;
...
privileged aspect AddressServiceImpl_Roo_Service_Impl {
    ...
    public void AddressServiceImpl.delete(Address address) {
        ...
        if (address.getCity() != null) {
            address.getCity().getAddresses().remove(address);
        }
     ...
     * @return Page
     */
    public Page<Address> AddressServiceImpl.findByCity(City city, GlobalSearch globalSearch, Pageable pageable) {
        return getAddressRepository().findByCity(city, globalSearch, pageable);
    }
     ...
     * @return Long
     */
    public long AddressServiceImpl.countByCity(City city) {
        return getAddressRepository().countByCity(city);
    }

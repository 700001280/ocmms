...
import com.ocmms.cmms.web.CitiesCollectionJsonController;
import com.ocmms.cmms.web.CitiesItemJsonController;
...
privileged aspect CitiesCollectionJsonController_Roo_JSON {
    ...
    public ResponseEntity<?> CitiesCollectionJsonController.create(@Valid @RequestBody City city, BindingResult result) {
    ...
    public ResponseEntity<?> CitiesCollectionJsonController.createBatch(@Valid @RequestBody Collection<City> cities, BindingResult result) {
    ...
    public ResponseEntity<?> CitiesCollectionJsonController.updateBatch(@Valid @RequestBody Collection<City> cities, BindingResult result) {
    ...
    public ResponseEntity<?> CitiesCollectionJsonController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {

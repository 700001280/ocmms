...
/**
 * = StorageLocationsCollectionThymeleafController
 TODO Auto-generated class documentation
 *
 */
@RooController(entity = StorageLocation.class, type = ControllerType.COLLECTION)
@RooThymeleaf
public class StorageLocationsCollectionThymeleafController {
     ...
     */
    @GetMapping(name = "exportStorageLocationPdf", value = "/exportstoragelocationpdf/pdf")
    @ResponseBody
    public ResponseEntity<?> exportStorageLocationPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {

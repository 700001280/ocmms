...
/**
 * = LotoInfoesCollectionThymeleafController
 TODO Auto-generated class documentation
 *
 */
@RooController(entity = LotoInfo.class, type = ControllerType.COLLECTION)
@RooThymeleaf
public class LotoInfoesCollectionThymeleafController {
     ...
     */
    @GetMapping(name = "exportLotoInfoPdf", value = "/exportlotoinfopdf/pdf")
    @ResponseBody
    public ResponseEntity<?> exportLotoInfoPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    	 Map<String, Object> parameters = new HashMap<>();
         parameters.put("title", "Storage Location BarCode");
    	
    	customReportProcessor.exportLotoTemplate(search,pageable,
    			response, new JasperReportsPdfExporter(), getLotoInfoService(),
    			parameters, locale);

...
import com.ocmms.cmms.web.CountriesCollectionJsonController;
import com.ocmms.cmms.web.CountriesItemJsonController;
...
privileged aspect CountriesCollectionJsonController_Roo_JSON {
    ...
    public ResponseEntity<?> CountriesCollectionJsonController.create(@Valid @RequestBody Country country, BindingResult result) {
    ...
    public ResponseEntity<?> CountriesCollectionJsonController.createBatch(@Valid @RequestBody Collection<Country> countries, BindingResult result) {
    ...
    public ResponseEntity<?> CountriesCollectionJsonController.updateBatch(@Valid @RequestBody Collection<Country> countries, BindingResult result) {
    ...
    public ResponseEntity<?> CountriesCollectionJsonController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {

...
public class ProcurementOrdersCollectionThymeleafController {
     ...
     */
    @GetMapping(name = "exportProcurementOrderPdf", value = "/exportprocurementorderpdf/pdf")
    @ResponseBody
    public ResponseEntity<?> exportProcurementOrderPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
